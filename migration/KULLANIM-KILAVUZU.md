...
- **Trimless rehberleri:** Trimless ürünlerinde (şablon `product.trimless`) uygulama adımları, kapak montajı, doğru / yanlış montaj, 45° kesim ve spot karşılaştırması firmanın rehber görselleriyle gelir. Adım metni ve görseli tema düzenleyicide her adım bloğundan, tek görsellik rehber "Özet görsel" alanından değişir. Karşılaştırma bölümünde ayrıca bir "Düzen" ayarı var: **kartlar** (her sütun kendi görseli ve ölçüt listesiyle) ya da **tablo**. Her bölümde bir "Görünüm" ayarı var: **kartlar** (varsayılan; web ve telefonda kart düzeni), **kartlar ve özet görsel** ya da **yalnız özet görsel**. Son seçenekte ekranda tek görsel kalır, içerik arama motorları için sayfada görünmez metin olarak durur.
