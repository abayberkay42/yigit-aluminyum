...
- **Trimless rehberleri:** Trimless ürünlerinde (şablon `product.trimless`) uygulama adımları, kapak montajı, doğru / yanlış montaj, 45° kesim ve spot karşılaştırması firmanın rehber görselleriyle gelir. Adım metni ve görseli tema düzenleyicide her adım bloğundan, bölümün altındaki tek görsellik rehber "Özet görsel" alanından değişir.
